...
|Tasks| 1. Develop serverless functions for various FaaS providers. <br> 2. Develop FCs in AFCL.<br> 3. Evaluate *FCs* with various workload (weak and strong scaling).|
